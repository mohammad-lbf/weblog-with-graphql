...
<div className=" py-5 text-white text-center container">
            ...
            <Link to="/aboutus" style={{fontSize:"14px" , fontWeight:"200" , width:"100px"}} className="d-flex align-items-center text-main-2 text-decoration-none flex-row-reverse justify-content-center">بیشتر بدانید<i className="ms-1 bi bi-arrow-right mt-1"></i></Link>
            </div>
        </div>
        </div>

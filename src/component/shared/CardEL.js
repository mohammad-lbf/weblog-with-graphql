...
const CardEL = ({title , slug , coverphoto , author}) => {
    return (
        <div style={{height:"370px"}} className="d-flex flex-column align-items-center py-2 bg-light rounded border">
            ...
            <p style={{height:"80px" , fontSize:"13px"}} className="mb-0 text-center fw-bold border-bottom pt-3 w-100 mb-1 px-2">{title}</p>
